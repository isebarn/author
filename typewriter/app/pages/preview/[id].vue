...
<template>
  <div class="min-h-screen bg-paper py-10 px-4 font-typewriter">
    <div class="mx-auto w-full max-w-[680px]">
      <!-- Paper card -->
      <div
        class="bg-white rounded-2xl px-8 py-12 sm:px-14 sm:py-16"
      ...
      >
        <!-- Title -->
        <h1 class="text-[1.1rem] text-ink/50 mb-10 tracking-wide font-typewriter">
          {{ data?.title }}
        </h1>
